...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/huli/wechatLog/">微信登录日志列表</a></li>
		<li class="active"><a href="${ctx}/huli/wechatLog/form?id=${wechatLog.id}">微信登录日志<shiro:hasPermission name="huli:wechatLog:edit">${not empty wechatLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="huli:wechatLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wechatLog" action="${ctx}/huli/wechatLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">搜易贷用户uid：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="isSubscribe" htmlEscape="false" maxlength="2" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">用户使用语言区域：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="groupId" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="huli:wechatLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
