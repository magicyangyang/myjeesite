 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/huli/friendShareLog")
public class FriendShareLogController extends BaseController {
	...
	public String list(FriendShareLog friendShareLog, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<FriendShareLog> page = friendShareLogService.findPage(new Page<FriendShareLog>(request, response), friendShareLog); 
